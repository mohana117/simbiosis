...
class RegisterScreenState extends State<RegisterScreen> {
  ...
  final regEmailInput = TextEditingController();
  final regPasswordInput = TextEditingController();
  ...
  void dispose() {
    ...
    regEmailInput.dispose();
    regPasswordInput.dispose();
    confirmPasswordInput.dispose();
    super.dispose();
  }

  void pickCompanyLogo() {
        ...
        child: Wrap(
          children: [
            ListTile(
              ...
              onTap: () {
                Navigator.pop(ctx);
                getLogoImage(ImageSource.camera);
              },
            ),
            ListTile(
              ...
              onTap: () {
                Navigator.pop(ctx);
                getLogoImage(ImageSource.gallery);
              },
            ),
          ],
        ),
  ...
  Future<void> getLogoImage(ImageSource source) async {
    try {
  ...
  Future<void> handleRegister() async {
    ...
    await prefs.setString('email', regEmailInput.text.trim());
    await prefs.setString('password', regPasswordInput.text);
    if (companyLogo != null) {
      await prefs.setString('companyLogoPath', companyLogo!.path);
    }
              ...
              children: [
                ...
                const Align(
                  ...
                  child: Padding(
                    ...
                    child: Text(
                      'Structured Address *',
                      style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold, color: Color(0xFF0F382C)),
                    ),
                  ),
                ),
                const Text(
                  ...
                  child: Column(
                    ...
                    children: [
                      const Text(
                        ...
                        style: TextStyle(fontWeight: FontWeight.w600, color: Color(0xFF0F382C)),
                      ),
                      const SizedBox(height: 4),
                ...
                _buildField(
                  ...
                  controller: regEmailInput,
                  keyboardType: TextInputType.emailAddress,
                  validator: validateEmail,
                ),
                _buildField(
                  label: 'Password *',
                  controller: regPasswordInput,
                  isObscure: true,
                ...
                _buildField(
                  ...
                  validator: (v) {
                    ...
                    if (v != regPasswordInput.text) return 'Passwords do not match';
                    return null;
                  },
                ),
